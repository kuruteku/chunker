...
class Chunker
  def initialize
    ...
    @verbs = ["se dělá","si mastí","onanuje","znásilňuje Mařku","znásilňuje Ivonu","sleduje porno","jí majonézu","stříká do sklenice od okurkového salátu","honí buřtíka","vraždí učitele","twerkuje","líže kladivo","mlátí do klávesnice a druhou rukou si hladí pubické ochlupení","olizuje plakát s fotkou Dana","trhá učebnici němčiny","poslouchá Pe Cimpoi","se nechává mlátit Vlasákem","ničí Vlasákovo auto","hází balalajkou","pláče u indické telenovely o krásné Penisnazádě, jíž osud připravil strastiplnou cestu z vrcholu až na dno, natáčené převážně"]
    @endings = ["v lednici","na záchodě","ve sborovně","v kabinetě fyziky","na fairwayi","u Dana doma","v Supermarketu","ve stánku s kuřaty","na Fortune Islandu","v Polsku","na koncertě Lindsey Stirling","za tvými zády","na střeše Danova domu","v bordelu","v Drážďanech","ve vlaku","v Biografu Modřany","v posteli","na balkóně","v taxíku","na pláži","v učebně IKT","ve Vlasákově autě","na greenu","ve spawnchuncích","v Serekundě","na podvozku auta paní profesorky Zymonové","v Netheru","v hotelu Jednota","v Ivonově","v jaderném reaktoru","v SSSR"]
  end
